...
--  AUTO UPDATE CONFIG
-- ════════════════════════════════════════════════
local CURRENT_VERSION  = "5.1"   -- versi script ini (admin update via panel)
...
function main()
    ...
    chat("{00FF00}[PrimeBot v5.1]{FFFFFF} Panel Ready! Ketik {00FF00}/autosusu")
...
imgui.OnFrame(
    ...
    function()
        ...
        imgui.Spacing()
        imgui.TextColored(imgui.ImVec4(0,0.85,1,1), utf8("AutoSusu CPRP v5.1 — Key License"))
        imgui.Separator()
        imgui.Spacing()
...
imgui.OnFrame(
    ...
    function()
        ...
        imgui.Begin(utf8("AutoSusu CPRP v5.1)"), showPanel)
